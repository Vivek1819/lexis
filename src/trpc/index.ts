...
export const appRouter = router({
  authCallback: publicProcedure.query(async () => {  //query is used to get data from the server
    ...
    const dbUser = await db.user.findFirst({    //dbUser is the user in the database
      where: {
        id: user.id
      }
    })
