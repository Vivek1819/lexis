                    ...
                    <div className="flex items-center justify-center h-full w-full">
                        <label
                            ...
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                <Cloud className="h-9 w-9 text-zinc-500 mb-2" />
                            ...
                            {acceptedFiles && acceptedFiles[0] ? (
                                <div className="mx-w-xs bg-white flex items-center rounded-md overflow-hidden outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200">
                            ...
                            {isUploading ? (
                                <div className="w-full mt-4 max-w-xs mx-auto">;
                                    ...
                                    {uploadProgress === 100 ?
                                        (
                                            <div className="flex gap-1 items-cente  justify-center text-sm text-zinc-700 text-center pt-2">
